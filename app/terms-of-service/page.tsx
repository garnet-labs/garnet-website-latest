        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">This Agreement</h2>
              
              <h3 className="text-xl font-medium mb-3">Acceptance of this Agreement</h3>
              <p className="mb-4 text-gray-600 dark:text-gray-300 leading-relaxed">
                By accessing the website located at https://garnet.ai (the "Site"), installing or using any other software supplied by Garnet, accessing any information, function, feature, application, product or service made available by Garnet, or registering an account with Garnet (the "Service"), you are a "User" and you hereby represent and warrant that:
              </p>
              
              <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-600 dark:text-gray-300">
                <li>you have read, understand and agree, without limitation or qualification, to be bound by this Agreement and any other policies or terms referenced within or posted throughout the Service from time to time, including but not limited to the Privacy Policy, which are hereby expressly incorporated by reference into this Agreement;</li>
                <li>if you are an individual, you are of legal age in the jurisdiction in which you reside to form a binding contract with Garnet (the "Minimum Age") and you have the authority to enter into the Agreement personally; and</li>
                <li>if you are representing, an entity, organization, company or other group (each an "Entity"), you are an authorized representative of such Entity and you have the authority to enter into the Agreement on behalf of such Entity and to bind such Entity to the Agreement.</li>
              </ul>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">Closing Your Account</h2>
              <p className="mb-4 text-gray-600 dark:text-gray-300 leading-relaxed">
                You may close your account at any time and without cost, but you will remain liable for any outstanding purchases, fees or other charges incurred with respect to the Service. Once an account is closed, Garnet will not issue refunds for any amounts previously incurred with respect to the Service. You may close your account by emailing <a href="mailto:support@garnet.ai" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">support@garnet.ai</a>.
              </p>
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-medium mb-3">Garnet IP</h3>
              <p className="mb-4 text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
                <div className="grid grid-cols-2 gap-4 md:gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      <a href="mailto:support@garnet.ai" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">support@garnet.ai</a>
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      <a href="mailto:legal@garnet.ai" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">legal@garnet.ai</a>
                    </p>
                  </div>
                </div>
              </div>
